...
package com.employeemanagement.hrdb.service;
...
public class HrdbQueryExecutorServiceImpl implements HrdbQueryExecutorService {
    ...
    @Override
    public UserNameCountResponse executeUserNameCount(String username) {
        Map<String, Object> params = new HashMap<>(1);

        params.put("username", username);

        return queryExecutor.executeNamedQuery("userNameCount", params, UserNameCountResponse.class);
    }
